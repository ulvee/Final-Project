...
function Collections() {
  return (
    <div className="about-page-main">
      ...
      <div className="py-[100px] flex flex-col gap-[50px] max-w-[1000px] w-[100%] mx-auto">
        <div className="flex justify-between">
          <div className="bg-[#eec387] pt-[30px] w-[30%] h-[220px] flex flex-col gap-[30px] rounded-[10px] shadow-xl cursor-pointer collections-items">
          ...
          <div className="bg-[#79d9c7] pt-[30px] flex flex-col w-[30%] h-[220px] gap-[30px] rounded-[10px] shadow-xl cursor-pointer collections-items">
            <div className="px-[25px]">
          ...
          <div className="bg-[#ffa0a0] pt-[30px] flex flex-col w-[30%] h-[220px] gap-[30px] rounded-[10px] shadow-xl cursor-pointer collections-items">
            <div className="px-[25px]">
        ...
        <div className="flex justify-between">
          <div className="bg-[#84cdf0] pt-[30px] flex flex-col w-[30%] h-[220px] gap-[30px] rounded-[10px] shadow-xl cursor-pointer collections-items">
            <div className="px-[25px]">
              <Link to={"/courses"}>
                <h2 className="text-[white] uppercase text-[20px] font-medium">
                  Introductory
          ...
          <div className="bg-[#eec387] pt-[30px] flex flex-col w-[30%] h-[220px] gap-[30px] rounded-[10px] shadow-xl cursor-pointer collections-items">
            <div className="px-[25px]">
              <Link to={"/courses"}>
                <h2 className="text-[white] uppercase text-[20px] font-medium">
                  Wordpress
